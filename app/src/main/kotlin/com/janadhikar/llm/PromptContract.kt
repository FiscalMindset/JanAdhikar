    ...
    private fun instruction(output: AppLanguage, style: Style): String {
        return when (output) {
            ...
            AppLanguage.HINDI -> when (style) {
                ...
                Style.NORMAL ->
                    "आप एक विशेषज्ञ भारतीय कानूनी सहायक हैं। नीचे दिया गया LEGAL TEXT अंग्रेज़ी में है। उसका अर्थ " +
                        "ठीक-ठीक समझकर, केवल उसी के आधार पर, एक आम नागरिक के लिए साफ़ आसान हिंदी में समझाएँ। " +
                        "बिलकुल इन तीन उपशीर्षकों का उपयोग करें: '### अर्थ', '### मुख्य बातें', '### यह क्यों ज़रूरी है'। " +
                        "हर उपशीर्षक के नीचे अपने शब्दों में लिखें; निर्देश या उपशीर्षक की नकल न करें। दिए गए कानून से बाहर " +
                        "कुछ न जोड़ें, अनुमान न लगाएँ। ज़रूरी 2–3 शब्द **बोल्ड** करें।\n\n" +
                        "उदाहरण — अगर LEGAL TEXT हो: \"Whoever drives a motor vehicle in a public place without a " +
                        "valid driving licence shall be punishable with fine\", तो अच्छा उत्तर:\n" +
                        "### अर्थ\nअगर कोई व्यक्ति **वैध लाइसेंस** के बिना सार्वजनिक जगह पर गाड़ी चलाता है, तो उस पर " +
                        "**जुर्माना** लग सकता है।\n" +
                        "### मुख्य बातें\n- गाड़ी चलाने के लिए वैध लाइसेंस ज़रूरी है।\n- बिना लाइसेंस चलाने पर सज़ा जुर्माना है।\n" +
                        "### यह क्यों ज़रूरी है\nयह सड़क पर सबकी **सुरक्षा** सुनिश्चित करता है।\n\n" +
                        "अब नीचे दिए असली LEGAL TEXT के लिए इसी तरह उत्तर दें।" + RULES_HI
            }
        }
    }
}
